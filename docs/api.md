...
- All protected endpoints require merchant authentication
- Public endpoints are used by the checkout page
- Payments always transition through processing → success / failed
- Card payments use Luhn algorithm and network detection
- UPI payments validate VPA format
